# Guia de deploy — Preditor de tendências virais e sentimento

> Versão **1.0.0** · Stack: **Go, Python, Scikit-learn, PostgreSQL**
...
3. Execute `go test ./... && pytest pkg/ml/tests/ -q` ou smoke tests automatizados.
