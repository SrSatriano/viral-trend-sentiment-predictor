# Arquitetura — Preditor de tendências virais e sentimento

> Versão do documento: **1.0.0** · Última revisão: **2026-03-26**

## 1. Visão geral

Coleta Go + features em Postgres + Gradient Boosting com validação temporal.
...
|------------|------------------|
| Scraper | Scraper TikTok/YouTube |
| Séries | Séries temporais de views e sentimento |
| Gradient | Gradient Boosting com split temporal |
| Cron | Cron jobs documentados |
| Schema | Schema SQL versionado |
